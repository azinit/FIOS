...
phrases = {
    ...
    'problem': ['Как прошел твой день?', 'Что тебя сегодня впечатлило?', 'Как ты оцениваешь свое состояние?',
    ...
    'main': ['Итак... твой главный вопрос?', 'Так что же тебя на самом деле волнует, Илья?', 'И что тебя гложет?',
             'Ии... чем могу помочь?)', 'Так в чем дело?', 'Слушаю)', 'Выскажись', 'Я вся во внимании', 'Дерзай'],
